...
const replayRequestsMessage = async function() {
  ...
  while (entry = await this.shiftRequest()) {
    try {
      ...
      // custom modification of the method ends here
...
class BackgroundSyncMessagePlugin extends workbox.backgroundSync.Plugin {
  ...
  constructor(...queueArgs) {
    // we should add a custom onSync function to modify replayRequests() as fetchDidSucceed is not called from this version of the bgsync plugin
    let args = { ...queueArgs}
